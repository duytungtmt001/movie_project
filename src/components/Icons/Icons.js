...
export const SubtitleIconVideo = ({ width = '3rem', height = '3rem', className, onClick }) => (
    <svg
        width={width}
        height={height}
        className={cx('icon', { [className]: className })}
    ...
    >
        <path
            d="M19.72 2.667c6.736 0 9.613 2.877 9.613 9.612v7.442c0 6.735-2.877 9.612-9.612 9.612h-7.442c-6.735 0-9.612-2.877-9.612-9.612v-7.442c0-6.735 2.877-9.612 9.612-9.612h7.442zm0 1.86h-7.44c-5.719 0-7.753 2.034-7.753 7.752v7.442c0 5.718 2.034 7.752 7.752 7.752h7.442c5.718 0 7.752-2.034 7.752-7.752v-7.442c0-5.718-2.034-7.752-7.752-7.752zm3.102 16.844c.509 0 .93.421.93.93 0 .508-.421.93-.93.93h-2.294a.937.937 0 0 1-.93-.93c0-.509.421-.93.93-.93h2.294zm-5.619 0a.929.929 0 1 1 0 1.86H9.178a.937.937 0 0 1-.93-.93c0-.509.422-.93.93-.93h8.025zm5.62-4.664c.508 0 .93.422.93.93 0 .51-.422.93-.93.93h-6.86a.937.937 0 0 1-.93-.93c0-.508.422-.93.93-.93h6.86zm-10.209 0c.508 0 .93.422.93.93 0 .51-.422.93-.93.93H9.178a.937.937 0 0 1-.93-.93c0-.508.422-.93.93-.93h3.436z"
            fill="#FFF"
            fillRule="evenodd"
        ></path>
    </svg>
...
export const SizeIconVideo = ({ width = '3rem', height = '3rem', className, onClick }) => (
    <svg
        width={width}
        height={height}
        className={cx('icon', { [className]: className })}
    ...
    >
        <path
            d="M21.486 27.28a1.028 1.028 0 0 1 .14 2.044l-.14.01H5.029a1.028 1.028 0 0 1-.14-2.045l.14-.01h16.457zm5.485-5.478a1.028 1.028 0 0 1 .14 2.045l-.14.009H5.03a1.028 1.028 0 0 1-.14-2.045l.14-.01H26.97zM25.961 9.72l.006-.035a1.029 1.029 0 0 1 2.024.08l.009.14v7.446a1.028 1.028 0 0 1-2.04.187 4.78 4.78 0 0 1-6.116-.535 4.764 4.764 0 0 1 0-6.746 4.783 4.783 0 0 1 6.117-.537zM10.441 4h.018a1.022 1.022 0 0 1 .345.083l.025.012c.022.01.044.02.065.032l-.09-.044a1.038 1.038 0 0 1 .474.413l.009.016c.014.024.027.05.04.076l.014.033 4.343 10.084c.012.025.024.05.034.077l.938 2.182a1.03 1.03 0 0 1-1.826.936l-.064-.125-.687-1.594H6.697l-.688 1.595a1.03 1.03 0 0 1-1.936-.681l.047-.132.915-2.122a1.02 1.02 0 0 1 .076-.177L9.45 4.62l.017-.037.028-.054-.044.09a1.035 1.035 0 0 1 .538-.536l.011-.005c.021-.009.042-.017.064-.024l-.075.029A1.04 1.04 0 0 1 10.373 4l.068.001zm10.857 7.708a2.712 2.712 0 0 0 0 3.842 2.722 2.722 0 0 0 3.848-.001 2.712 2.712 0 0 0 .159-3.668l-.16-.173-.173-.16a2.723 2.723 0 0 0-3.674.16zM10.394 7.623l-2.81 6.505h5.611l-2.801-6.505z"
            fill="#FFF"
            fillRule="evenodd"
        ></path>
    </svg>
...
export const SoundIconVideo = ({ width = '3rem', height = '3rem', className, onClick }) => (
    <svg
        width={width}
        height={height}
        className={cx('icon', { [className]: className })}
    ...
    >
        <path
            d="M16 2.667c.52 0 .951.386 1.02.886l.009.14v24.615c0 .566-.46 1.025-1.029 1.025-.52 0-.951-.386-1.02-.886l-.009-.14V3.693c0-.566.46-1.025 1.029-1.025zm-5.486 4.102c.521 0 .951.386 1.02.887l.009.139v16.41c0 .567-.46 1.026-1.029 1.026-.52 0-.95-.386-1.019-.887l-.01-.139V7.795c0-.567.461-1.026 1.03-1.026zm10.972 0c.52 0 .95.386 1.019.887l.01.139v16.41c0 .567-.461 1.026-1.03 1.026-.52 0-.95-.386-1.018-.887l-.01-.139V7.795c0-.567.46-1.026 1.029-1.026zM5.029 12.24c.52 0 .95.386 1.019.887l.01.139v5.47c0 .566-.461 1.026-1.03 1.026-.52 0-.95-.386-1.019-.887L4 18.735v-5.47c0-.566.46-1.026 1.029-1.026zm21.942 0c.521 0 .952.386 1.02.887l.009.139v5.47c0 .566-.46 1.026-1.029 1.026-.52 0-.95-.386-1.019-.887l-.01-.139v-5.47c0-.566.461-1.026 1.03-1.026z"
            fill="#FFF"
            fillRule="evenodd"
        ></path>
    </svg>
...
export const TickIconVideo = ({ width = '3rem', height = '3rem', className, onClick }) => (
    <svg
        width={width}
        height={height}
        className={cx('icon', { [className]: className })}
    ...
    >
        <path
            d="M19.47 5.97a.75.75 0 0 1 1.133.976l-.073.084-11 11a.75.75 0 0 1-.976.073l-.084-.073-5-5a.75.75 0 0 1 .976-1.133l.084.073L9 16.439l10.47-10.47z"
            fill="#FFF"
            fillRule="evenodd"
        ></path>
    </svg>
...
export const LoginIcon = ({ width = '3rem', height = '3rem', className, onClick }) => (
    <svg
        width={width}
        height={height}
        className={cx('icon', { [className]: className })}
...
export const UserIcon = ({ width = '3rem', height = '3rem', className, onClick }) => (
    <svg
        width={width}
        height={height}
        className={cx('icon', { [className]: className })}
